...
`}}function openNav(){document.getElementById("mySidenav").style.width="100%"}function closeNav(){document.getElementById("mySidenav").style.width="0"}function openAirline(){document.getElementById("myAirline1").classList.toggle("show")}function openHotel(){document.getElementById("myHotel1").classList.toggle("show")}function openSS(){document.getElementById("mySS1").classList.toggle("show")}function myFunction1(){document.getElementById("myAirline").classList.toggle("show")}function myFunction2(){document.getElementById("myHotel").classList.toggle("show")}function myFunction3(){document.getElementById("mySS").classList.toggle("show")}customElements.define("nav-bar",navBar),window.onclick=function(e){if(!e.target.matches(".dropbtn1")){var i,a=document.getElementsByClassName("dropdown-content");for(i=0;i<a.length;i++){var t=a[i];t.classList.contains("show")&&t.classList.remove("show")}}},window.onclick=function(e){if(!e.target.matches(".dropbtn2")){var i,a=document.getElementsByClassName("dropdown-content");for(i=0;i<a.length;i++){var t=a[i];t.classList.contains("show")&&t.classList.remove("show")}}},window.onclick=function(e){if(!e.target.matches(".dropbtn3")){var i,a=document.getElementsByClassName("dropdown-content");for(i=0;i<a.length;i++){var t=a[i];t.classList.contains("show")&&t.classList.remove("show")}}},window.onclick=function(e){if(!e.target.matches(".dropbtn")){var i,a=document.getElementsByClassName("dropdown-content");for(i=0;i<a.length;i++){var t=a[i];t.classList.contains("show")&&t.classList.remove("show")}}};